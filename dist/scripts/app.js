...
var closeMobileMenu = document.querySelector('.header__mobile-close');
var listOfLinks = document.querySelectorAll('.header__link-mobile');
...
listOfLinks.forEach(function (e) {
...
var city = document.querySelector('.header__geo');
var isLoaded = false;
...
var cities = document.querySelector('.header__cities');
var citiesInput = document.querySelector('.header__cities-input');
var citiesList = document.querySelector('.header__cities-list');
var citiesItems = [];
var updatedItems = [];
var preloader = document.querySelector('.preloader');
var citiesSave = document.querySelector('.header__cities-save');
function getCities() {
  return _getCities.apply(this, arguments);
}
function _getCities() {
  _getCities = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var resp, data;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            data.map(function (item) {
              if (item.cities) {
                item.cities.map(function (city) {
                  return citiesItems.push(city.name);
                });
              } else {
...
function hasCity() {
  ...
  if (citiesInput.value) {
    citiesItems.forEach(function (e) {
...
function startListenerItems() {
  document.querySelectorAll('.header__cities-item').forEach(function (e) {
